...
class Encoder(nn.Module):
    def __init__(self, opt):
        ...
        self.fc1 = nn.Linear(opt.resSize+opt.attSize, opt.nz)
        self.fc3 = nn.Linear(opt.nz, 600)
        self.lrelu = nn.LeakyReLU(0.2, True)
        self.linear_means = nn.Linear(600, opt.nz)
        self.linear_log_var = nn.Linear(600, opt.nz)
        self.apply(weights_init)
